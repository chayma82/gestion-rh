...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Factures d'achat archivées</h1>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($factures as $facture)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $facture->nom_fournisseur }}</td>
                            ...
                            <td class="px-6 py-4">
                                <form action="{{ route('factures.achats.desarchiver',$facture->id) }}" method="POST"
