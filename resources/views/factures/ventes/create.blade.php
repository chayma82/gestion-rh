...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Nouvelle facture de vente</h1>
    ...
    <form action="{{ route('factures.ventes.store') }}" method="POST" id="formFacture" enctype="multipart/form-data">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-1 text-xs text-gray-400">
                        Client introuvable ? <a href="{{ route('clients.create') }}" class="text-[#E2721B] hover:underline">Ajouter un client</a>
                    </p>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200/60 shadow-[0_4px_25px_rgba(0,0,0,0.04)] overflow-hidden mb-6">
            ...
            @php
                $anciennesLignes = old('lignes', [
                    ['reference' => '', 'designation' => '', 'description' => '', 'quantite' => 1, 'unite' => '', 'prix_unitaire' => '', 'taux_tva' => 19],
                ]);
            @endphp
...
<script>
    ...
    document.getElementById('btnAjouterLigne').addEventListener('click', function () {
        ...
        ligne.querySelectorAll('input').forEach(function (champ) {
            ...
            if (champ.name.includes('quantite')) {
                champ.value = '1';
            } else if (champ.name.includes('taux_tva')) {
                champ.value = '19';
            } else {
                champ.value = '';
            }
